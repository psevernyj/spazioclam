...
const translations = {
  it: {
    ...
    hero: {
      ...
      whomCards: [
        { num: "01", title: "Sport da combattimento",    text: "Percorsi mirati per migliorare forza, mobilità e performance, sostenendo le esigenze specifiche dello sport praticato e lavorando sulla prevenzione degli infortuni.", tags: ["Performance", "Forza", "Prevenzione"] },
        { num: "02", title: "Allenamento intensivo",     text: "Per atleti che vogliono sostenere carichi elevati in modo sicuro, progressivo ed efficace, con il metodo Strength & Conditioning e la giusta consapevolezza del movimento.", tags: ["Recupero", "Carichi elevati", "Sicurezza"] },
        { num: "03", title: "Recupero post-infortunio",  text: "Un percorso graduale per recuperare movimento, forza e fiducia nel tuo corpo e tornare all'attività fisica in modo consapevole.", tags: ["Dolore", "Mobilità"] },
        { num: "04", title: "Postura & vita sedentaria", text: "Percorsi dedicati a chi trascorre molte ore seduto e vuole migliorare postura, mobilità e qualità del movimento.", tags: ["Schiena", "Cervicale", "Postura"] },
      ],
  ...
  en: {
    ...
    hero: {
      ...
      whomCards: [
        { num: "01", title: "Combat sports",           text: "Targeted programmes to improve strength, mobility and performance, supporting the specific demands of your sport and working on injury prevention.", tags: ["Performance", "Strength", "Prevention"] },
        { num: "02", title: "Intensive training",      text: "For athletes who want to sustain high loads safely, progressively and effectively, with the Strength & Conditioning method and the right body awareness.", tags: ["Recovery", "High loads", "Safety"] },
        { num: "03", title: "Post-injury recovery",    text: "A gradual programme to recover movement, strength and confidence in your body, and return to physical activity mindfully.", tags: ["Pain", "Mobility"] },
        { num: "04", title: "Posture & sedentary life", text: "Programmes for those who spend many hours sitting and want to improve posture, mobility and movement quality.", tags: ["Back", "Neck", "Posture"] },
      ],
