  ...
  it: {
    ...
    services: {
      ...
      items: [
        ...
        { id: "pancafit",        size: "md", index: "3",                             title: "Pancafit® — Metodo Raggi®",    desc: "Percorso di riequilibrio posturale basato sull'allungamento muscolare globale decompensato.", tags: ["Postura", "Cervicale", "Lombalgia"], badge: null as string | null },
        { id: "tecniche",        size: "md", index: "4",                             title: "Coppettazione, Gua Sha, Moxa", desc: "Tecniche complementari che possono essere integrate nel trattamento quando ritenute appropriate.", tags: ["Circolazione", "Rigenerazione", "Tensioni"], badge: null as string | null },
        { id: "linfodrenaggio",  size: "md", index: "5",                             title: "Linfodrenaggio",               desc: "Tecnica manuale delicata finalizzata a favorire il drenaggio linfatico e a supportare la gestione di gonfiore ed edema, quando indicato.", tags: ["Edemi", "Gonfiore", "Ritenzione"], badge: null as string | null },
  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { id: "pancafit",        size: "md", index: "3",                      title: "Pancafit® — Raggi® Method", desc: "A postural rebalancing programme based on global decompensated muscle stretching.", tags: ["Posture", "Neck", "Back pain"], badge: null as string | null },
        { id: "tecniche",        size: "md", index: "4",                      title: "Cupping, Gua Sha, Moxa",    desc: "Complementary techniques that can be integrated into treatment when deemed appropriate.", tags: ["Circulation", "Regeneration", "Tension"], badge: null as string | null },
        { id: "linfodrenaggio",  size: "md", index: "5",                      title: "Lymphatic drainage",        desc: "A gentle manual technique designed to support lymphatic drainage and help manage swelling and oedema, when indicated.", tags: ["Oedema", "Swelling", "Retention"], badge: null as string | null },
